'''
python3 scripts/custom/run-sam.py --data_dir data/
'''
...
CHECKPOINT = os.path.expanduser("~/InstantAvatar/third_party/segment-anything/ckpts/sam_vit_h_4b8939.pth")
MODEL = "vit_h"
...
if __name__ == "__main__":
    ...
    for fn, pts in tqdm(zip(img_lists, keypoints)):
        img = cv2.imread(fn)
